...
rem echo /eagle/estar/tpe/dynamic/dat/nxgrdc/reference desk/ >> .git/info/sparse-checkout
rem echo /eagle/estar/tpe/dynamic/profiledat/ >> .git/info/sparse-checkout
rem echo /eagle/estar/tpe/dynamic/resultprofiledll/ >> .git/info/sparse-checkout
rem echo /EDM/ >> .git/info/sparse-checkout
rem echo /src/pace/ >> .git/info/sparse-checkout
rem echo /src/reportprofiledlls/ >> .git/info/sparse-checkout
